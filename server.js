...
function start() {
    ...
    // laterjs schedule test


    var later = require('later');
    var sched = later.parse.text("before 8:00 pm and after 8:00 am on the 5th through 22nd day of the month except after 11:00 am and before 12:00 pm");
    // TIME IS NOT IN EST/EDT. Its in GMT
    console.log(sched);
    console.log(sched.schedules);
    console.log(sched.error);
    console.log(sched.exceptions);
    var schedule = later.schedule(sched);
    // console.log(schedule);
    // console.log(schedule.error);

    console.log(schedule.nextRange(5));
    ...
    // var t = schedule.tasks().id(function(d) {
    //     return d.name;
    // }).duration(function(d) {
    //     return d.length * 60;
    ...
    // var r = schedule.resources().id(function(d) {
    //     return d.name;
    // });
